...
void main() {
  ...
  test('editPosition com autoKey cria keyframes mesmo com o auto-key global desligado', () {
    ...
    e.editPosition(id, const Duration(seconds: 1), const Offset(400, 400), autoKey: true);
    final l = c.read(editorControllerProvider).layerById(id)!;
    expect(l.position.isAnimated, isTrue);
    expect(l.position.keyframes.length, 2, reason: 'ancora em 0 s e o novo em 1 s');
  });

...
class _FolhaDeExportarState extends ConsumerState<FolhaDeExportar> {
  ...
  Widget build(BuildContext context) {
    ...
    final duracaoSegundos = bruta is Scene3DLayer && bruta.duration.inMicroseconds > 0
        ? (bruta.duration.inMicroseconds / 1e6).round()
        : 10;
    final duracaoTexto = '00:${duracaoSegundos.toString().padLeft(2, '0')}';
            ...
            children: [
              ...
              Row(
                children: [
                  ...
                  Expanded(
                    child: _buildFormatPill('Imagem', _FormatoExportar.imagem),
                  ),
                ],
              ),
            ],
        ...
        Padding(
          ...
          child: Scene3DActionButton(
            ...
            onPressed: () {
              ...
              // Abre a tela de exportação de vídeo com pipeline acelerado por GPU C++
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          icon: const Icon(Icons.keyboard_arrow_down_rounded, color: Scene3DTheme.textMuted),
          isExpanded: true,
          style: const TextStyle(
            fontSize: 14,
            fontWeight: FontWeight.w600,
